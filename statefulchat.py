...
def show_context(messages: list):
    try:
        ...
        print("Rich no está instalada. Instálala con: uv pip install rich  (o)  pip install rich")
        return
...
def main():
    ...
    try:
        ...
        from rich.panel import Panel
        console = Console()
        console.rule("Stateful Chatbot - Responses API")
    ...
    try:
        while True:
            ...
            append_and_log(messages, "user", user_input, log_file, log_json_path)
            ...
            try:
                ...
                try:
                    ...
                    print(f"Bot: {text}")
                append_and_log(messages, "assistant", text, log_file, log_json_path)
